...
Implement comprehensive k6 load test scenarios covering baseline performance, stress testing, spike testing, soak
testing, and end-to-end CDC latency measurement.
