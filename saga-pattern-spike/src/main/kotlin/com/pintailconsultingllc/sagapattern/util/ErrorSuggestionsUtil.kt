...
/**
 * Utility for generating user-facing error suggestions based on error codes.
 *
 * Provides actionable suggestions to help customers resolve order failures.
 */
object ErrorSuggestionsUtil {
    /**
     * Generate suggestions based on the error code.
     *
     * @param errorCode The error code from the failed saga step
     * @return A list of actionable suggestions for the customer
     */
